...
class Q(object):
    ...
    # XXX TOOLZ: change log name to '/tmp/toolz'
    OUTPUT_PATH = os.path.join(os.environ.get('TMPDIR') or os.environ.get('TEMP') or '/tmp', 'toolz')
...
q = Q()  # XXX TOOLZ: make it an object instead
